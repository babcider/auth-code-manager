...
export default function HomePage() {
  ...
  const handleDeleteClick = (code: AuthCode) => {
    setDeleteConfirmId(code.id);
  };

  const handleDeleteConfirm = async (codeId: string) => {
    if (!codeId || deleteLoading) return;
    ...
    try {
      ...
      alert(error instanceof Error ? error.message : '코드 삭제 중 오류가 발생했습니다.');
    } finally {
